#ifndef HALIDE__imgResizer___image_resizer_h
#define HALIDE__imgResizer___image_resizer_h
#include <stdint.h>
...
int image_resizer(struct halide_buffer_t *_input_buffer, int32_t _output_width, int32_t _output_height, struct halide_buffer_t *_output_buffer);

HALIDE_FUNCTION_ATTRS
int image_resizer_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *image_resizer_metadata();
