...
Java_com_example_pixiologist_PixiologistModule_nativeInstall(JNIEnv *env, jobject thiz, jlong jsi_ptr, jobject assetManager) {
    try {
        __android_log_print(ANDROID_LOG_INFO, "PixiologistTag", "Initializing with Asset Manager");


        AAssetManager *mgr = AAssetManager_fromJava(env, assetManager);
        if (mgr == nullptr) {
            __android_log_print(ANDROID_LOG_ERROR, "PixiologistTag", "Failed to obtain AAssetManager");
            return JNI_FALSE;
        }
        ...
        if (asset == nullptr) {
            __android_log_print(ANDROID_LOG_ERROR, "PixiologistTag", "Failed to open asset");
            return JNI_FALSE;
        }
        ...
        __android_log_print(ANDROID_LOG_INFO, "PixiologistTag", "Image resized with OpenCV took %d microseconds", cv_duration.count());
        ...
        __android_log_print(ANDROID_LOG_INFO, "PixiologistTag", "Image resize with Halide took %d microseconds", halide_duration.count());
        ...
        __android_log_print(ANDROID_LOG_ERROR, "PixiologistTag", "Unknown error occurred during installation");
        return JNI_FALSE;
    }
}
