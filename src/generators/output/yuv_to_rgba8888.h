#ifndef HALIDE__output___yuv_to_rgba8888_h
#define HALIDE__output___yuv_to_rgba8888_h
#include <stdint.h>
...
int yuv_to_rgba8888(struct halide_buffer_t *_y__buffer, struct halide_buffer_t *_u__buffer, struct halide_buffer_t *_v__buffer, struct halide_buffer_t *_argb_output__buffer);

HALIDE_FUNCTION_ATTRS
int yuv_to_rgba8888_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *yuv_to_rgba8888_metadata();
